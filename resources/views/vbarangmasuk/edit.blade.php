                    ...
                    <div class="card-body">
                        <form action="{{ route('barangmasuk.update',$rsetbarangmasuk->id) }}" method="POST" enctype="multipart/form-data">                    
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror" name="tgl_masuk" value="{{ old('tgl_masuk',$rsetbarangmasuk->tgl_masuk) }}" placeholder="Masukkan Tanggal Masuk">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('barang_id') is-invalid @enderror" name="barang_id" value="{{ old('barang_id',$rsetbarangmasuk->barang_id) }}" placeholder="Masukkan ID Barang">
